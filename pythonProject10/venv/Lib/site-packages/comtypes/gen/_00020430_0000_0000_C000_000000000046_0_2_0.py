...
IFontDisp = Font
__all__ = [ 'OLE_COLOR', 'OLE_XSIZE_HIMETRIC', 'FONTSIZE', 'FONTBOLD',
           'OLE_YPOS_HIMETRIC', 'LoadPictureConstants',
           'IPictureDisp', 'IFontEventsDisp', 'OLE_YPOS_PIXELS',
           'Unchecked', 'StdPicture', 'OLE_CANCELBOOL',
           'FONTUNDERSCORE', 'OLE_YSIZE_CONTAINER', 'FontEvents',
           'OLE_HANDLE', 'Picture', 'IPicture', 'OLE_XSIZE_PIXELS',
           'IFont', 'OLE_XSIZE_CONTAINER', 'OLE_TRISTATE', 'Checked',
           'OLE_YSIZE_PIXELS', 'OLE_XPOS_CONTAINER', 'Gray', 'Color',
           'IFontDisp', 'OLE_XPOS_PIXELS', 'StdFont',
           'OLE_OPTEXCLUSIVE', 'Default', 'OLE_ENABLEDEFAULTBOOL',
           'Monochrome', 'FONTNAME', 'OLE_XPOS_HIMETRIC',
           'FONTITALIC', 'Font', 'VgaColor', 'OLE_YPOS_CONTAINER',
           'FONTSTRIKETHROUGH', 'OLE_YSIZE_HIMETRIC']
